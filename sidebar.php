<div class="col-md-2 pt-5 bg-dark">
    <ul class="nav flex-column ml-3 mb-5">
        <li class="nav-item"><a class="nav-link active text-white" href="index.php"><i class="fas fa-brandcamp"></i> Dasboard</a>
        <hr class="bg-secondary"></li>
        <li class="nav-item"><a class="nav-link active text-white" href="penjualan.php"><i class="fas fa-brandcamp"></i> Penjualan</a></li>
